...
|---|---|---|
| [haskell-mts](https://github.com/lambdasistemi/haskell-mts) | Merkle Tree Store — CSMT + MPF library with Lean 4 proofs and WASM targets | [Jun 2026](https://github.com/lambdasistemi/haskell-mts/wiki/Logbook-June-2026) |
| [cardano-mpfs-offchain](https://github.com/lambdasistemi/cardano-mpfs-offchain) | Merkle Patricia Forestry server — proof-carrying API, RocksDB persistence, devnet | [Jul 2026](https://github.com/lambdasistemi/cardano-mpfs-offchain/wiki/Logbook-July-2026) |
| [cardano-utxo-csmt](https://github.com/lambdasistemi/cardano-utxo-csmt) | CSMT over the Cardano UTxO set — HTTP service for inclusion proofs | [Jun 2026](https://github.com/lambdasistemi/cardano-utxo-csmt/wiki/Logbook-June-2026) |
| [cardano-stake-csmt](https://github.com/lambdasistemi/cardano-stake-csmt) | CSMT over per-epoch stake distribution — verifiable stake-weighted voting proofs | [Jun 2026](https://github.com/lambdasistemi/cardano-stake-csmt/wiki/Logbook-June-2026) |
| [cardano-ledger-rdf](https://github.com/lambdasistemi/cardano-ledger-rdf) | Cardano ledger to RDF — transaction graph emitter and SPARQL tooling | [Jul 2026](https://github.com/lambdasistemi/cardano-ledger-rdf/wiki/Logbook-July-2026) |
| [cardano-knowledge-maps](https://github.com/lambdasistemi/cardano-knowledge-maps) | Interactive knowledge graph of Cardano governance (CIP-1694 / Conway era) | [Jun 2026](https://github.com/lambdasistemi/cardano-knowledge-maps/wiki/Logbook-June-2026) |
...
| [zk-lab](https://github.com/lambdasistemi/zk-lab) | Lab for intention-driven zero-knowledge DSL targeting Plutus | |
